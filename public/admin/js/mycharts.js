    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [full["South Imenti"], full["North Imenti"], full["Tigania East"], full["Tigania West"], full["Igembe South"], full["Buuri"], ["Central Imenti"],full["Igembe Central"], full["Igembe North"]],
                backgroundColor: [
                    'rgba(255,99,132,1)',
                    'rgba(54, 162, 235, 1)',
                    'rgba(255, 206, 86, 1)',
